...
export function Hero({ depositHref = "/deposit", analyticsHref = "/analytics" }: HeroProps) {
  return (
    <section style={{
      ...
      <div>
        ...
        <div style={{ display: "flex", gap: "12px" }}>
          <Link href={depositHref} style={{ textDecoration: "none" }}>
            <Button size="lg" tone="apex">Start Earning →</Button>
          </Link>
          <Link href={analyticsHref} style={{ textDecoration: "none" }}>
