...
const TONE = {
  core: "var(--core-500)", seam: "var(--seam-500)", apex: "var(--apex-500)",
  positive: "var(--positive)", warning: "var(--warning)", danger: "var(--danger)",
  ink: "var(--rock-700)", accent: "var(--accent-500)",
};
...
export function StrataBar({
  value = 0, max = 100, tone = "ink", target, height = 10,
  label, valueLabel, style, ...rest
}) {
