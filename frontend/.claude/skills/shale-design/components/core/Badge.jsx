 ...
 */
export function Badge({ children, tone = "neutral", dot = false, outline = false, mono = false, style, ...rest }) {
  ...
  return (
    ...
    >
      {dot && (
        <span style={{ width: 7, height: 7, borderRadius: "var(--r-pill)", background: "currentColor", flex: "none" }} />
      )}
      {children}
    </span>
  );
